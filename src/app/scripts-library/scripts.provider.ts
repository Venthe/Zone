...
import { Scripts, Script } from './scripts.model';
import { AttributeKeys as AttributeKey } from '../player/player.model';
import { GameDifficulty } from '../game/game.model';
...
export class ScriptsProvider {
    ...
    constructor() {
        ...
        this.scripts["noLessThanZero"] = ({ value, scriptsLibrary }) => scriptsLibrary.execute("noLessThan", { value, compareTo: 0 });
        this.scripts["noLessThanOne"] = ({ value, scriptsLibrary }) => scriptsLibrary.execute("noLessThan", { value, compareTo: 1 });
