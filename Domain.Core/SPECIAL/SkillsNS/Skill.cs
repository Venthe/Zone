...
{
    public class Skill : AbstractEntity<string>, ITranslatedEntity<IBaseTranslation, string>
    {
        ...
        private readonly SkillTranslationRepository translations = new SkillTranslationRepository();
